 ...
 <form action="make_order.php" id="checkout-frm" method="POST">
 				...
 				<div class="col-lg-8">
 					...
 					<div class="card">
 						<div class="card-body">
 							...
 							<div class="form-group">
 								...
 								<input type="text" name="mobile" required="" class="form-control" value="">
 							</div>
 							<div class="form-group">
 					...
 					<?php
						if (isset($_SESSION['login_user_id'])) {
							...
							$data = "where c.client_ip = '" . $ip . "'  AND c.status = '0'";
						}
						$total = 0;
						$count = 0;
 								...
 								<div class="row">
 									...
 									<div class="col-md-4">
 										...
 										<div class="input-group mb-3">
 											...
 											<input type="hidden" name="product_<?= $count ?>" value=<?= $row['product_id'] ?>>
 											<input type="text" readonly value="<?php echo $row['qty'] ?>" min=1 class="form-control text-center" name="qty_<?= $count ?>">
 											<!-- <div class="input-group-prepend">
 					...
 					<div class="sticky">
 						<div class="card">
 							<div class="card-body">
 								...
 								<hr>
 								<input type="hidden" name="num_of_items" value="<?= $count ?>">
 								<div class="text-center">
 									<button class="btn btn-block btn-outline-primary" type="submit" id="">Order</button>
 								</div>
 							</div>
 						</div>
 					</div>
